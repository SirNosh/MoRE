...
rec = [
    ...
    dict(
        ...
        hf_config=dict(org="tomg-group-umd", name="moe-huginn-3.5b"),
        block_size=4096,
        vocab_size=65536,
        padding_multiple=4096,
        tie_embeddings=True,
...
######################
# MoE-Huginn Configurations
######################
moe_huginn_configs = [
    dict(
        name="moe-huginn-3.5b",
        hf_config=dict(org="tomg-group-umd", name="huginn-0125"),
        architecture_class_name="RecurrentGPT",
        # Base Huginn config
        d_model=2560,
        n_heads=20, 
        ...
        rope_settings=dict(use_rope=True, rope_condense_ratio=1, rope_base=50000),
    ),
    dict(
        name="moe-huginn-1.5b",
        hf_config=dict(org="tomg-group-umd", name="huginn-0125"),
        architecture_class_name="RecurrentGPT",
        # Base Huginn config
        d_model=1536,
...
# Add MoE-Huginn configs to the main configs list
configs.extend(moe_huginn_configs)
